    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
      <div className="">
        <Datepicker
          ...
          value={dateValue}
          theme={"light"}
          inputClassName="input input-bordered w-72 dark:bg-[#0b0255]"
      ...
      <div className="text-right ">
        ...
        <div className="dropdown dropdown-bottom dropdown-end  ml-2">
          ...
          <ul
            tabIndex={0}
            className="dropdown-content menu menu-compact  p-2 shadow bg-base-100 dark:bg-[#0b0255] rounded-box w-52"
          >
            <li>
              <a>
